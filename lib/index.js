...
function generateOtherXLocationsBothTubes(min, max) {
  ...
  obstacleAboveArray.push (new Obstacle (NewObstacleXLocation, NewObstacleHeightUpperObstacle - 800, 75,
    NewObstacleHeightUpperObstacle, '../assets/tubes_uper_use.png'))
}
